...
<div class="modal fade" id="ModalPosting"  data-backdrop="static">
    <div class="modal-dialog modal-default">  <!-- modal-(sm, lg, xl) ukuran lebar modal -->
        <div class="modal-content bg-warning w3-animate-zoom">
            ...
            <div class="modal-header">
                    <h3 class="modal-title"><i style="font-size:18" class="fa">&#xf093;</i><b> Posting Simpanan Setor</b></h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
...
$(document).ready(function(){
    ...
    data1Datatable = tampil_data1();    
     function tampil_data1(){
        ...
        return $('#data1').DataTable({            
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.laporan.rekeningkoran_show')}}`,
            columns: [
    ...
    function tampil_data_carinasabah(){
        ...
        return $('#carinasabah').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.transaksi.tsetor_shownasabah')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    //         processing: true,
    //         serverSide: true,
    //         ajax   : `{{route('simpanan01.laporan.rekeningkoran_shownasabah')}}`,
    //         columns: [
    //             // { data: 'no', name:'id', render: function (data, type, row, meta) {
    //             //     return meta.row + meta.settings._iDisplayStart + 1;
    //             // }},
    ...
    function cariid(cari){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('simpanan01/laporan/rekeningkoranedit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.laporan.rekeningkoran_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('simpanan01/laporan/rekeningkorandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_data();
