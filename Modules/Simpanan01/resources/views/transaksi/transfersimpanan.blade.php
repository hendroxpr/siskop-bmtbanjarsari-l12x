        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-7 input-group" style="color:blue;">
                        <h4><b>ASAL REKENING</b></h4>
                         <input name="asalx1" id="asalx1" type="hidden">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                    ...
                    <div class="col-md-7 input-group">
                        ...
                        <input name="cariidx1" id="cariidx1" class="form-control w3-input w3-border rounded-0" type="search" value="{{ session('norekx1') }}" placeholder="Search" autocomplete="off" autofocus>                        
                ...
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                        <h6>Nama</h6> 
                        <input name="idnasabahx1" id="idnasabahx1" type="hidden" value="{{ session('idnasabahx1') }}">
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input name="norekx1" id="norekx1" class="w3-input w3-border" type="text" placeholder="Nomor Rekening" value="{{ session('norekx1') }}" readonly>                         
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                        ...
                        <input name="idjenissimpananx1" id="idjenissimpananx1" type="hidden" value="{{ session('idjenissimpananx1') }}">
                    </div>
                    <div class="col-md-7">
                        <input name="jenissimpananx1" id="jenissimpananx1" class="w3-input w3-border" type="text" placeholder="Produk" value="{{ session('jenissimpananx1') }}" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input name="saldox1" id="saldox1" class="w3-input w3-border" type="text" placeholder="saldo" value="{{ session('saldox1') }}" readonly>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 input-group">
                        <input name="cekprint2" id="cekprint2" type="hidden" value="0">
                        <input name="cariidx2" id="cariidx2" class="form-control w3-input w3-border rounded-0" type="search" value="{{ session('norekx2') }}" placeholder="Search" autocomplete="off" autofocus>                        
                        <div class="input-group-append">
                          <button id="btn_cariidx2" name="btn_cariidx2" type="button" style="border-radius:0px; border:none;"><i style="font-size:24" class="fas">&#xf002;</i></button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                        <h6>Nama</h6> 
                        <input name="idnasabahx2" id="idnasabahx2" type="hidden" value="{{ session('idnasabahx2') }}">
                    </div>
                    <div class="col-md-7">
                        <input name="namax2" id="namax2" class="w3-input w3-border" type="text" placeholder="Nama" value="{{ session('namax2') }}" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input name="norekx2" id="norekx2" class="w3-input w3-border" type="text" placeholder="Nomor Rekening" value="{{ session('norekx2') }}" readonly>                         
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                        <h6>Jenis Simpanan</h6> 
                        <input name="idjenissimpananx2" id="idjenissimpananx2" type="hidden" value="{{ session('idjenissimpananx2') }}">
                    </div>
                    <div class="col-md-7">
                        <input name="jenissimpananx2" id="jenissimpananx2" class="w3-input w3-border" type="text" placeholder="jenis simpanan" value="{{ session('jenissimpananx2') }}" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input name="niax2" id="niax2" class="w3-input w3-border" type="text" placeholder="NIA" value="{{ session('niax2') }}" readonly>                         
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                    ...
                    <div class="col-md-7">
                        <input name="nikx2" id="nikx2" class="w3-input w3-border" type="text" placeholder="NIK" value="{{ session('nikx2') }}" readonly>  
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                    ...
                    <div class="col-md-7">
                        <input name="ecardx2" id="ecardx2" class="w3-input w3-border" type="text" placeholder="Ecard" value="{{ session('ecardx2') }}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                    ...
                    <div class="col-md-7">
                        <input name="saldox2" id="saldox2" class="w3-input w3-border" type="text" placeholder="saldo" value="{{ session('saldox2') }}" readonly>
                    </div>
                </div>
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 input-group">
                                    <input name="nomorbukti1" id="nomorbukti1" class="form-control w3-input w3-border rounded-0" type="search" placeholder="TFR.001.20230131.001" disabled value="{{ session('nomorbukti1') }}">                        
                                    <div class="input-group-append">
			...
			<div class="modal-content bg-info w3-animate-zoom">
				...
				<form class="form-horizontal">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div id="reload" class="table-responsive">
								<table id="carinasabah" width="100%" class="table table-bordered table-striped table-hover">
									<thead>
									<tr>
										<th style="width:10px;">#</th>                            
                                        <th style="width:100px">Nama</th>							
                                        <th style="width:100px">Norek</th>							
								...
								<tfoot id="show_footercarinasabah">
									
								</tfoot>
								<tbody id="show_datacarinasabah">
...
<div class="modal fade" id="ModalPosting"  data-backdrop="static">
    <div class="modal-dialog modal-default">  <!-- modal-(sm, lg, xl) ukuran lebar modal -->
        <div class="modal-content bg-warning w3-animate-zoom">
            ...
            <div class="modal-header">
                    <h3 class="modal-title"><i style="font-size:18" class="fa">&#xf093;</i><b> Posting Transfer Simpanan</b></h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-1 mb-4" align="center">									
                            <h4 class="mt-2"><span id="nomorstatus6" name="nomorstatus6" style="display: none;"></span></h4>
                        </div>                        								  
                    </div>
...
$(document).ready(function(){
    ...
    //  data1Datatable = tampil_data1();   
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.transaksi.transfersimpanan_show')}}`,
            columns: [
     ...
     carinasabahDatatable = tampil_data_carinasabah();    
     function tampil_data_carinasabah(){
        let i = 1;	
        return $('#carinasabah').DataTable({
            responsive : true,
            retrieve: true,
            autoWidth : true,
            // buttons : [ {extend: 'colvis', postfixButtons: [ 'colvisRestore' ] }, {extend:'copy'}, {extend:'csv'}, {extend: 'pdf', orientation: 'portrait', pageSize: 'A4', title:'{{ $caption }}'}, {extend: 'excel', title: '{{ $caption }}'}, {extend:'print', orientation: 'portrait', pageSize: 'A4', title: '{{ $caption }}'}, ],        
            ...
            processing: true,  
            serverSide: true,
            ajax   : `{{route('simpanan01.transaksi.transfersimpanan_shownasabah')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
                ...
                { data: 'jenissimpanan', name: 'jenissimpanan.jenissimpanan' },
    ...
    function cariid(cari){
        var cari1=cari;
        var asalx1=$('#asalx1').val();
        
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
            ...
            success : function(data){ 
                ...
                var y;                
                 for(i=0; i<resultData.length; i++){  
                    if(asalx1=='asal'){
                        $('#idnasabahx1').val(resultData[i].id);
                        $('#namax1').val(resultData[i].nama); 
                        $('#norekx1').val(resultData[i].norek);
                        $('#niax1').val(resultData[i].nia);
                        $('#nikx1').val(resultData[i].nik);
                        $('#ecardx1').val(resultData[i].ecard);
                        $('#idjenissimpananx1').val(resultData[i].idjenissimpanan);
                        $('#jenissimpananx1').val(resultData[i].jenissimpanan.jenissimpanan);
                        $('#saldox1').val(formatAngka(resultData[i].saldox,''));
                    }else{
                        $('#idnasabahx2').val(resultData[i].id);
                        $('#namax2').val(resultData[i].nama); 
                        $('#norekx2').val(resultData[i].norek);
                        $('#niax2').val(resultData[i].nia);
                        $('#nikx2').val(resultData[i].nik);
                        $('#ecardx2').val(resultData[i].ecard);
                        $('#idjenissimpananx2').val(resultData[i].idjenissimpanan);
                        $('#jenissimpananx2').val(resultData[i].jenissimpanan.jenissimpanan);
                        $('#saldox2').val(formatAngka(resultData[i].saldox,''));
                    }                       
                }
    ...
    function carinomorbukti(cari){
        var cari1=cari;

        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_carinomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    $('#btn_cariidx1').on('click',function(){
        $('#asalx1').val('asal');
        carinasabahDatatable.draw(null, false);
        setTimeout(() => {
            $('#ModalCariID').modal('show');
        }, 300);
    });
    $('#btn_cariidx2').on('click',function(){
        $('#asalx1').val('tujuan');
        carinasabahDatatable.draw(null, false);
        setTimeout(() => {
            $('#ModalCariID').modal('show');
    ...
    $('#show_datacarinasabah').on('click','.item_ecard',function(){
        ambilcari(this);
    });
    $('#show_datacarinasabah').on('click','.item_nia',function(){
        ambilcari(this);
    });
    $('#show_datacarinasabah').on('click','.item_nik',function(){
        ambilcari(this);
    });
    $('#show_datacarinasabah').on('click','.item_nama',function(){
        ambilcari(this);
    });
    $('#show_datacarinasabah').on('click','.item_ecard',function(){
        ambilcari(this);        
    ...
    function ambilcari(t){
        ...
        var idjenissimpanan1 = $(t).attr('data14');
        var jenissimpanan1 = $(t).attr('data15');
        ...
        if(asalx1=='asal'){
            $('#id3').val(data1);
            $('#saldox1').val(formatAngka(saldo1,''));
            $('#ecardx1').val(ecard1);
            $('#norekx1').val(norek1);
            $('#niax1').val(nia1);
            $('#nikx1').val(nik1);
            $('#namax1').val(nama1);
            $('#idnasabahx1').val(id1);
            $('#idjenissimpananx1').val(idjenissimpanan1);
            $('#jenissimpananx1').val(jenissimpanan1);
            ...
            $('#saldox2').val(formatAngka(saldo1,''));
            $('#ecardx2').val(ecard1);
            $('#norekx2').val(norek1);
            $('#niax2').val(nia1);
            $('#nikx2').val(nik1);
            $('#namax2').val(nama1);
            $('#idnasabahx2').val(id1);
            $('#idjenissimpananx2').val(idjenissimpanan1);
            $('#jenissimpananx2').val(jenissimpanan1);
    ...
    $("#btn_nomorbukti1").on('click',function(){ 
        nomorbukti();
        let a = $("#cariidx1").val();              
        let b = $("#jenissimpananx1").val();
        let a2 = $("#cariidx2").val();              
        let b2 = $("#jenissimpananx2").val();
        $("#keterangan1").val('Transfer ' + b + ' ' + a + ' ke ' + b2 + ' ' + a2 ); 
        setTimeout(() => {
            kirimsyarat();
            setTimeout(() => {
                 data1Datatable = tampil_data1();
    ...
    function kirimsyarat(){
        ...
        var saldox1=$('#saldox1').val();
        var idnasabahx1=$('#idnasabahx1').val();
        var norekx1=$('#norekx1').val();
        var idjenissimpananx1=$('#idjenissimpananx1').val();
        var jenissimpananx1=$('#jenissimpananx1').val();
        
        var cariidx2=$('#cariidx2').val();
        var namax2=$('#namax2').val();
        var niax2=$('#niax2').val();
        var nikx2=$('#nikx2').val();
        var ecardx2=$('#ecardx2').val();
        var saldox2=$('#saldox2').val();
        var idnasabahx2=$('#idnasabahx2').val();
        var norekx2=$('#norekx2').val();
        var idjenissimpananx2=$('#idjenissimpananx2').val();
        var jenissimpananx2=$('#jenissimpananx2').val();
        ...
        let formData = new FormData();
            ...
            formData.append('saldox1', saldox1);
            formData.append('idnasabahx1', idnasabahx1);
            formData.append('norekx1', norekx1);
            formData.append('idjenissimpananx1', idjenissimpananx1);
            formData.append('jenissimpananx1', jenissimpananx1);
            
            formData.append('cariidx2', cariidx2);
            formData.append('namax2', namax2);
            formData.append('niax2', niax2);
            formData.append('nikx2', nikx2);
            formData.append('ecardx2', ecardx2);
            formData.append('saldox2', saldox2);
            formData.append('idnasabahx2', idnasabahx2);
            formData.append('norekx2', norekx2);
            formData.append('idjenissimpananx2', idjenissimpananx2);
            formData.append('jenissimpananx2', jenissimpananx2);
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    $("#jml1").on('change',function(){
        ...
        var saldo = $('#saldox1').val().replace(/[^,\d]/g, '').toString();
        var px = parseFloat(x);
        var psaldo = parseFloat(saldo);
        if(px>=psaldo){
            x=saldo;
        }
    ...
    function data_simpan(){
        ...
        var tgltransaksi1=$('#tgltransaksi1').val();
        var nomorbukti1=$('#nomorbukti1').val();
        var idnasabah1=$('#idnasabahx1').val();
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti_ok(){        
        var tgltransaksi1=$('#tgltransaksi1').val();

        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('simpanan01/transaksi/transfersimpananedit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        var idtargetx2 = $('#idnasabahx2').val();        
        var idjenissimpananx2 = $('#idjenissimpananx2').val();        
        ...
        let formData = new FormData();
            ...
            formData.append('idtargetx2', idtargetx2);            
            formData.append('idjenissimpananx2', idjenissimpananx2);            
          
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.transaksi.transfersimpanan_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('simpanan01/transaksi/transfersimpanandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_datatable();
    ...
    $('#show_data1').on('click','.item_print',function(){ //item_print
    ...
    $("#btn_print6").on('click',function(){ 
        ...
        var idx = $('#id6').val() + '_' + $("#noprint6").val();        
        window.open('{{ url('simpanan01/transaksi/transfersimpananprintdetail') }}/'+ idx);
    });
