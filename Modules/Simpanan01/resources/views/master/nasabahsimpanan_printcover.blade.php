...
<div>
  <table style="width: 100%" border="0">
        ...
        <tr>
            <td style="width: 80%" style="font-size: 1.2em;">{{ $jenissimpanan }} - {{ $keterangan }}</td>    
        </tr>
        <tr>
        ...
        <td valign="top">
          <table style="width: 100%" border="0" class="keterangan">
            ...
            @php
                ...
                $jenissimpananx = Jenissimpanan::select('*')            
                    ->get();
            @endphp

            @foreach ($jenissimpananx as $item2)
              <tr>
                <td align="center">{{ $nox++ }}</td>
                <td>{{ $item2->jenissimpanan }}</td>
