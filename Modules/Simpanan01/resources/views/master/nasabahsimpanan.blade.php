...
@php
    ...
    $idjenissimpanan = session('idjenissimpananx1');
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <select name="idjenissimpananx1" id="idjenissimpananx1" class="w3-input w3-border" value="{{ $idjenissimpanan }}"></select> 
                    </div>
                </div>
...
$(document).ready(function(){
    ...
    $("#btn_norek1").on('click',function(){
        ...
        var prod = $('#idjenissimpananx1 option:selected').text();
    ...
    //menampilkan combo jenissimpananx
    function tampil_listjenissimpananx(){				
        $.ajax({
            type: 'get',
            ...
            success: function(data){				    
                ...
                $("#idjenissimpananx1").val({{ $idjenissimpanan }});
            }
        })                    
    }
    ...
    function tampil_listtandapengenal1(){				
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.master.nasabahsimpanan_show')}}`,
            columns: [
    ...
    function tampil_carianggota1(){
        ...
        return $('#carianggota1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.master.nasabahsimpanan_showanggota')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    function data_import(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('simpanan01.master.nasabahsimpanan_import')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    $("#idjenissimpananx1").on('change',function(){ 
        setTimeout(() => {
            kirimsyarat();
        }, 500);
        setTimeout(() => {
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.master.nasabahsimpanan_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.master.nasabahsimpanan_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('simpanan01/master/nasabahsimpananedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
    ...
    function data_update(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('simpanan01.master.nasabahsimpanan_update')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('simpanan01/master/nasabahsimpanandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
    ...
    $('#show_data1').on('click','.item_printcover',function(){
        ...
        window.open('{{ url('simpanan01/master/nasabahsimpananprintcover') }}/'+ norekx);     
    });

    $('#show_data1').on('click','.item_printheader',function(){
        var norekx = $(this).attr('data5');        
        window.open('{{ url('simpanan01/master/nasabahsimpananprintheader') }}/'+ norekx);      
    });
