...
$(document).ready(function(){
    ...
    function tampil_listbahan(){				
        $.ajax({
            type: 'get',
            url   : '{{route('simpanan01.master.uang_listbahan')}}',
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('simpanan01.master.uang_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('simpanan01.master.uang_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('simpanan01/master/uangedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('simpanan01/master/uangdestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
