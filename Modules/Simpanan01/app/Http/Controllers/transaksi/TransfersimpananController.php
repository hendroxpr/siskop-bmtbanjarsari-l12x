...
namespace Modules\Simpanan01\Http\Controllers\transaksi;
...
class TransfersimpananController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Transfer Simpanan</b>.<br>
            <div class="row">
        ...
        ';
        $page = 'simpanan01::transaksi.transfersimpanan';
        $link = '/simpanan01/transaksi/transfersimpanan';
        $subtitle = 'Transaksi';
        $caption = 'Transfer Simpanan';
        $jmlhal = 2;
    ...
    public function posting(Request $request)
    {
        ...
        $idtargetx2 = $request['idtargetx2'];  
        $idjenissimpananx2 = $request['idjenissimpananx2'];  
        ...
        ->get();
        foreach ($tampil3 as $baris) {
            $idcoad1 = $baris->idcoatfkeluard;
            $idcoak1 = $baris->idcoatfkeluark;
            
            $idkelompokd1 = $baris->coatfkeluard->kodekelompok;
            $idkelompokk1 = $baris->coatfkeluark->kodekelompok;
            
            $idkategorid1 = $baris->coatfkeluard->idkategori;
            $idkategorik1 = $baris->coatfkeluark->idkategori;
            
            $idjenisjurnald1 = $baris->jenisjurnaltfkeluard->id;
            $idjenisjurnalk1 = $baris->jenisjurnaltfkeluark->id;
        }
        
        //tabel jenisimpananx2
        $tampil3 = Jenissimpanan::select('*')
        ->with(['coasetord','coasetork','coatarikd','coatarikk','coatfmasukd','coatfmasukk',
            'coatfkeluard','coatfkeluark','jenisjurnalsetord','jenisjurnalsetork',
            'jenisjurnaltarikd','jenisjurnaltarikk','jenisjurnaltfmasukd','jenisjurnaltfmasukk',
            'jenisjurnaltfkeluard','jenisjurnaltfkeluark'])
        ->where('id','=',$idjenissimpananx2)
        ->get();
        foreach ($tampil3 as $baris) {
            $idcoadx2 = $baris->idcoatfkeluard;
            $idcoakx2 = $baris->idcoatfkeluark;
            
            $idkelompokdx2 = $baris->coatfkeluard->kodekelompok;
            $idkelompokkx2 = $baris->coatfkeluark->kodekelompok;
            
            $idkategoridx2 = $baris->coatfkeluard->idkategori;
            $idkategorikx2 = $baris->coatfkeluark->idkategori;
            
            $idjenisjurnaldx2 = $baris->jenisjurnaltfkeluard->id;
            $idjenisjurnalkx2 = $baris->jenisjurnaltfkeluark->id;
        }
        ...
        */
        ...
        $data2 = [
            ...
            'nomorb' => $nomorb1,
            'idjenissimpanan' => $idjenissimpananx2,
            'idcoa' => $idcoakx2,
            'idtarget' => $idtargetx2,
            'idsandi' => 3,
            'idjenisjurnal' => $idjenisjurnalk1,
    ...
    public function show()
    {
        ...
        ->addColumn('action', function ($row) {
            ...
            if(is_null($tglposting)){
                ...
                '<a href="#" title="Posting Data" class="btn btn-warning btn-xs item_posting" 
                    data="' . $row->id . '" 
                    data2="'. $row->idnasabah.'" 
                    data3="'. $row->tgltransaksi.'" 
                    data4="'. $row->updated_at.'" 
                    ...
                    data6="'. $row->debet.'"
                ><i style="font-size:18px" class="fa">&#xf093;</i></a> ' .
                '<a href="#" title="Hapus Data" class="btn btn-danger btn-xs item_hapus" 
                    data="' . $row->id . '" 
                    data2="'. $row->idnasabah.'" 
                    data3="'. $row->tgltransaksi.'" 
                    data4="'. $row->updated_at.'" 
    ...
    public function nomorbukti(Request $request)
    {
        ...
        if ($jmldata==0){
            ...
            $nomor = Jurnalsimpanan::select('nomorb')
                ...
                ->whereRaw('left(nomorbukti,3) = ? ', ['TFR'])
                ->max('nomorb')+1;
        }  
        ...
        //nomor kwitansi contoh : TFR.001.20230527.0009
        $nbx = 'TFR' . '.' . $idx . '.' . $tgl1 . '.' . $no;  
        $nomorbukti = "'$nbx'";
    ...
    public function kirimsyarat(Request $request)
    {
        session([
            ...
            'cariidx2' => $request['cariidx2'],
            'namax2' => $request['namax2'],
            'norekx2' => $request['norekx2'],
            'niax2' => $request['niax2'],
            'nikx2' => $request['nikx2'],
            'ecardx2' => $request['ecardx2'],
            'saldox2' => $request['saldox2'],
            'idnasabahx2' => $request['idnasabahx2'],
            'idjenissimpananx2' => $request['idjenissimpananx2'],
            'jenissimpananx2' => $request['jenissimpananx2'],
