...
class SetorsimpananController extends Controller
{
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Setor Simpanan</b>.<br>
            <div class="row">
        ...
        ';
        $page = 'simpanan01::transaksi.setorsimpanan';
        $link = '/simpanan01/transaksi/setorsimpanan';
        $subtitle = 'Transaksi';
    ...
    public function create(Request $request)
    {
        ...
        foreach ($tampil as $baris) {
            ...
            $idcoasetork1 = $baris->jenissimpanan->idcoasetork;
        }
    ...
    public function show()
    {
        ...
        if($idcoasetork1=='0'||$idcoasetork1==''){
            $idcoasetork1=1;
        }
    ...
    public function nomorbukti(Request $request)
    {
        ...
        if ($jmldata==0){
            ...
            $nomor = Jurnalsimpanan::select('nomorb')
                ...
                ->whereRaw('left(nomorbukti,3) = ? ', ['STR'])
                ->max('nomorb')+1;
        }  
        ...
        //nomor kwitansi contoh : STR.001.20230527.0009
        $nbx = 'STR' . '.' . $idx . '.' . $tgl1 . '.' . $no;  
        $nomorbukti = "'$nbx'";
