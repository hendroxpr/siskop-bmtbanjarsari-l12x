...
class TariksimpananController extends Controller
{
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Tarik Simpanan</b>.<br>
            <div class="row">
        ...
        ';
        $page = 'simpanan01::transaksi.tariksimpanan';
        $link = '/simpanan01/transaksi/tariksimpanan';
        $subtitle = 'Transaksi';
        $caption = 'Tarik Simpanan';
        $jmlhal = 2;
