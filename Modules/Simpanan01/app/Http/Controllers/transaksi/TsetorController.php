...
class TsetorController extends Controller
{
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Simpanan Setor</b>.<br>
            <div class="row">
        ...
        ';
        $page = 'simpanan01::transaksi.tsetor';
        $link = '/simpanan01/transaksi/tsetor';
        $subtitle = 'Transaksi';
        $caption = 'Simpanan Setor';
        $jmlhal = 2;
