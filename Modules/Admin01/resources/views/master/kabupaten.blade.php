                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <select name="idpropinsi1" id="idpropinsi1" class="w3-input w3-border" value="{{ $idpropinsi }}"></select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="kabupaten1" id="kabupaten1" class="w3-input w3-border" type="text" maxlength="50" placeholder="Kabupaten" value="{{ old('kabupaten1') }}" required>
                                </div>
                            </div> 
...
$(document).ready(function(){
    ...
    $('#idpropinsix1').on('change',function(){
        setTimeout(() => {
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('admin01.master.kabupaten_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function tampil_listpropinsi1(){				
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('admin01.master.kabupaten_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('admin01.master.kabupaten_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
            ...
            error : function(formData){                    
                swalgagaltambah($('#kabupaten1').val());                 
                }
        });
    ...
    function data_edit(idx){
        ...
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('admin01/master/kabupatenedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                            ...
                            $('#idpropinsi1').val(resultData[i].idpropinsi);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('admin01/master/kabupatendestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
