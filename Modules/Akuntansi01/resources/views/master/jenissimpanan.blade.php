            ...
            <table id="data1" class="table table-bordered table-striped table-hover" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th style="width:50px">TfMasuk-D</th>							
                        <th style="width:50px">Tfmasuk-K</th>							
                        <th style="width:50px">Tfkeluar-D</th>							
                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">                                
                                    <input name="jenissimpanan1" id="jenissimpanan1" class="w3-input w3-border" maxlength="30" type="search" placeholder="jenis pinjaman"  value="{{ old('jenissimpanan1') }}" required>
                                </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-5">
                                    <select name="idcoaujrohd1" id="idcoaujrohd1" class="w3-input w3-border"></select>
                                </div>
                                <div class="col-md-5">
                                    <select name="idjenisjurnalujrohd1" id="idjenisjurnalujrohd1" class="w3-input w3-border"></select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-1" align="right">
                                ...
                                <div class="col-md-5">
                                    <select name="idcoaujrohk1" id="idcoaujrohk1" class="w3-input w3-border"></select>
                                </div>
                                <div class="col-md-5">
                                    <select name="idjenisjurnalujrohk1" id="idjenisjurnalujrohk1" class="w3-input w3-border"></select>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-2 mt-1" align="right">									
...
$(document).ready(function(){
    ...
    function tampil_listcoa(){				
        $.ajax({
            type: 'get',
            url   : '{{route('akuntansi01.master.jenissimpanan_listcoa')}}',
            ...
            success: function(data){
                ...
                $("#idcoaadmind1").html(data);
                $("#idcoaadmink1").html(data);
                $("#idcoaujrohd1").html(data);
                $("#idcoaujrohk1").html(data);
            }
        })                    
    }
    ...
    function tampil_listjenisjurnal(){				
        $.ajax({
            type: 'get',
            url   : '{{route('akuntansi01.master.jenissimpanan_listjenisjurnal')}}',
            ...
            success: function(data){
                ...
                $("#idjenisjurnaladmind1").html(data);
                $("#idjenisjurnaladmink1").html(data);
                $("#idjenisjurnalujrohd1").html(data);
                $("#idjenisjurnalujrohk1").html(data);
            }
        })                    
    }
    ...
    $("#ujrohb1").on('change',function(){
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('akuntansi01.master.jenissimpanan_show')}}`,
            columns: [
                ...
                { data: 'coaadmind', name: 'coaadmind', orderable: false },
                { data: 'coaadmink', name: 'coaadmink', orderable: false },
                { data: 'coaujrohd', name: 'coaujrohd', orderable: false },
                { data: 'coaujrohk', name: 'coaujrohk', orderable: false },
    ...
    function data_simpan(){
        ...
        var id1=$('#id1').val();        		
        var kode1=$('#kode1').val();
        var jenissimpanan1=$('#jenissimpanan1').val();
        ...
        var idcoaadmind1=$('#idcoaadmind1').val();
        var idcoaadmink1=$('#idcoaadmink1').val();
        var idcoaujrohd1=$('#idcoaujrohd1').val();
        var idcoaujrohk1=$('#idcoaujrohk1').val();
        ...
        var idjenisjurnaladmind1=$('#idjenisjurnaladmind1').val();
        var idjenisjurnaladmink1=$('#idjenisjurnaladmink1').val();
        var idjenisjurnalujrohd1=$('#idjenisjurnalujrohd1').val();
        var idjenisjurnalujrohk1=$('#idjenisjurnalujrohk1').val();
        ...
        let formData = new FormData();
            ...
            formData.append('jenissimpanan1', jenissimpanan1);
            ...
            formData.append('idcoaadmind1', idcoaadmind1);
            formData.append('idcoaadmink1', idcoaadmink1);
            formData.append('idcoaujrohd1', idcoaujrohd1);
            formData.append('idcoaujrohk1', idcoaujrohk1);
            ...
            formData.append('idjenisjurnaladmind1', idjenisjurnaladmind1);
            formData.append('idjenisjurnaladmink1', idjenisjurnaladmink1);
            formData.append('idjenisjurnalujrohd1', idjenisjurnalujrohd1);
            formData.append('idjenisjurnalujrohk1', idjenisjurnalujrohk1);
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('akuntansi01.master.jenissimpanan_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
            ...
            error : function(formData){ 
                ...
                swalgagaltambah(jenissimpanan1);                 
                }
        });
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('akuntansi01/master/jenissimpananedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                        ...
                        $('#jenissimpanan1').val(resultData[i].jenissimpanan);
                        ...
                        $('#idcoaadmind1').val(resultData[i].idcoaadmind);
                        $('#idcoaadmink1').val(resultData[i].idcoaadmink);
                        $('#idcoaujrohd1').val(resultData[i].idcoaujrohd);
                        $('#idcoaujrohk1').val(resultData[i].idcoaujrohk);
                        ...
                        $('#idjenisjurnaladmind1').val(resultData[i].idjenisjurnaladmind);
                        $('#idjenisjurnaladmink1').val(resultData[i].idjenisjurnaladmink);
                        $('#idjenisjurnalujrohd1').val(resultData[i].idjenisjurnalujrohd);
                        $('#idjenisjurnalujrohk1').val(resultData[i].idjenisjurnalujrohk);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('akuntansi01/master/jenissimpanandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
