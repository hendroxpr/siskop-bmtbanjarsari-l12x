                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">                                
                                    <input name="kode1" id="kode1" class="w3-input w3-border" maxlength="3" type="search" placeholder="kode" autofocus value="{{ old('kode1') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-1" align="right">									
                                    <h6 class="mt-2">Jurnal*)</h6>
                                </div>
                                <div class="col-md-5">                                
                                    <input name="jurnal1" id="jurnal1" class="w3-input w3-border" maxlength="30" type="search" placeholder="jurnal"  value="{{ old('jurnal1') }}" required>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    function tampil_listcoa(){				
        $.ajax({
            type: 'get',
            url   : '{{route('akuntansi01.pengaturan.setingjurnal_listcoa')}}',
    ...
    function tampil_listjenisjurnal(){				
        $.ajax({
            type: 'get',
            url   : '{{route('akuntansi01.pengaturan.setingjurnal_listjenisjurnal')}}',
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('akuntansi01.pengaturan.setingjurnal_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        let formData = new FormData();
            ...
            formData.append('jurnal1', jurnal1);
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('akuntansi01.pengaturan.setingjurnal_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('akuntansi01/pengaturan/setingjurnaledit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                        ...
                        $('#jurnal1').val(resultData[i].jurnal);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('akuntansi01/pengaturan/setingjurnaldestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
