...
$(document).ready(function(){
    ...
    $('#tab-penjualansajadetail').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajadetail');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    $('#tab-penjualansajaperitem').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajaperitem');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    $('#tab-penjualansajapercustomer').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajapercustomer');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    $('#tab-penjualansajaperfaktur').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajaperfaktur');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    $('#tab-penjualansajaperjenispembayaran').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajaperjenispembayaran');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    $('#tab-penjualansajapertanggal').on('click',function(){
        $('#tabpenjualansaja1').val('tab-penjualansajapertanggal');
        $('#event1').val('0');
        setTimeout(() => {
            kirimsyarat();	
        }, 100);
    ...
    function koneksi_datatable(){
        ...
        penjualansajapertanggal1Datatable = tampil_pembelianpertanggal1(); 
    }
