            ...
            <table id="data1" class="table table-bordered table-striped table-hover" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th style="width:120px">Jenis Biaya</th>
...
$(document).ready(function(){
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pos01.laporan.biayabiaya2_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function tampil_listruang(){				
        $.ajax({
            type: 'get',
            url   : '{{route('pos01.laporan.biayabiaya2_listruang')}}',
    ...
    function tampil_listkategoribiaya(){				
        $.ajax({
            type: 'get',
            url   : '{{route('pos01.laporan.biayabiaya2_listkategoribiaya')}}',
    ...
    function tampil_listjenisbiaya(){				
        $.ajax({
            type: 'get',
            url   : '{{route('pos01.laporan.biayabiaya2_listjenisbiaya')}}',
...
footerCallback: function (row, data, start, end, display) {
            ...
            // Update footer
            api.column(6).footer().innerHTML = 'SUB TOTAL :';
            api.column(10).footer().innerHTML = formatAngka(pagesubtotal,'');            
            api.column(11).footer().innerHTML = formatAngka(pageppn,'');            
            api.column(12).footer().innerHTML = formatAngka(pagediskon,'');            
            api.column(13).footer().innerHTML = formatAngka(pagetotaljual,'');            
            },

            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.laporan.biayabiaya2_show')}}`,
            columns: [
                ...
                { data: 'jenisbiaya', name: 'jenisbiaya.jenisbiaya', className: 'dt-left' },
