...
Route::get('/laporan/penjualanshowpenjualansajapersupplier', [PenjualanController::class, 'showpenjualansajapersupplier'])->name('pos01.laporan.penjualan_showpenjualansajapersupplier')->middleware('auth'); /* menampilkan data showpenjualansajapersupplier pada datatable javascript */
