...
class NasabahtabunganController extends Controller
{
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Nasabah Tabungan</b>.';
        $page = 'tabungan01::master.nasabahtabungan';
        $link = '/tabungan01/master/nasabahtabungan';
        $subtitle = 'Master';
        $caption = 'Nasabah Tabungan';
        $jmlhal = 2;
    ...
    public function show()
    {
        ...
        $data = $datax
            ...
            ->addColumn('action', function ($row) {
                return '<a href="#" title="Edit Data" class="btn btn-success btn-xs item_edit" data="' . $row->id . '" data2="'. $row->nis.'" data3="'. $row->namalengkap.'" data4="'. $row->nisn.'"><i style="font-size:18px" class="fa">&#xf044;</i></a> ' .
                       '<a href="#" title="Hapus Data" class="btn btn-danger btn-xs item_hapus" data="' . $row->id . '" data2="'. $row->nis.'" data3="'. $row->namalengkap.'" data4="'. $row->nisn.'"><i style="font-size:18px" class="fa">&#xf00d;</i></a> ' .
                       '<a href="#" title="Print Cover" class="btn btn-info btn-xs item_printcover" data="' . $row->id . '" data2="'. $row->nis.'" data3="'. $row->namalengkap.'" data4="'. $row->nisn.'" data5="'. $row->norek.'"><i style="font-size:18px" class="fa">&#xf02f;</i></a> ' .
    ...
    public function printcover($norek)
    {
        ...
        $page = 'tabungan01::master.nasabahtabungan_printcover';
        $link = '/tabungan01/master/nasabahtabungan_printcover';
    ...
    public function printheader($norek)
    {
        ...
        $page = 'tabungan01::master.nasabahtabungan_printheader';
        $link = '/tabungan01/master/nasabahtabungan_printheader';
