                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 input-group">
                                    <input name="nomorbukti1" id="nomorbukti1" class="form-control w3-input w3-border rounded-0" type="search" placeholder="STR.20230131.001" disabled value="{{ session('nomorbukti1') }}">                        
                                    <div class="input-group-append">
...
$(document).ready(function(){
    ...
    data1Datatable = tampil_data1();    
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('tabungan01.transaksi.tsetor_show')}}`,
            columns: [
    ...
    function cariid(cari){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('tabungan01/transaksi/tsetoredit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.transaksi.tsetor_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('tabungan01/transaksi/tsetordestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_data();
    ...
    $('#show_data1').on('click','.item_print',function(){ //item_print
        ...
        kirimsyarat();
        setTimeout(() => {
            window.open('{{ route('tabungan01.laporan.rekeningkoran.index') }}');
        }, 100);
    });
