                ...
                <table id="data1" class="table table-bordered table-striped table-hover" style="width: 100%">
                    <thead>
                        <tr>
							...
							<th style="width:10px">Norek Sumber</th>
							<th style="width:100px">Nasabah Sumber</th>							
...
$(document).ready(function(){
    ...
    data1Datatable = tampil_data1();    
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('sibm01.transaksi.tfmasuk_show')}}`,
            columns: [
     ...
     function tampil_data_carisiswa(){
        ...
        return $('#carisiswa').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('sibm01.transaksi.tfmasuk_shownasabah')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
     ...
     function tampil_data_carisiswa1(){
        ...
        return $('#carisiswa1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('sibm01.transaksi.tfmasuk_shownasabah1')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    function cariid(cari){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    function cariid1(cari){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_cariid1')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    function kirimsyarat(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('sibm01/transaksi/tfmasukedit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('sibm01.transaksi.tfmasuk_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('sibm01/transaksi/tfmasukdestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                setTimeout(() => {
