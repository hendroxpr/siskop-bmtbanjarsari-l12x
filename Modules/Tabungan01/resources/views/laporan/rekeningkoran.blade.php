            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 input-group">
                        <input name="cekprint6" id="cekprint6" type="hidden" value="0">                        
                        <input name="cariidx1" id="cariidx1" class="form-control w3-input w3-border rounded-0" type="search" value="{{ session('cariidx1') }}" placeholder="Search" autocomplete="off" autofocus>                        
                ...
                <div class="row">
                    <div class="col-md-4 mt-2 text-right">
                        <h6>Produk</h6> 
                        <input name="idproduktabunganx1" id="idproduktabunganx1" type="hidden" value="{{ session('idproduktabunganx1') }}">
                    </div>
                    <div class="col-md-7">
                        <input name="produktabunganx1" id="produktabunganx1" class="w3-input w3-border" type="text" placeholder="Produk" value="{{ session('produktabunganx1') }}" readonly>
                    </div>
                </div>
...
<div class="modal fade" id="ModalPosting"  data-backdrop="static">
    <div class="modal-dialog modal-default">  <!-- modal-(sm, lg, xl) ukuran lebar modal -->
        <div class="modal-content bg-warning w3-animate-zoom">
            ...
            <div class="modal-header">
                    <h3 class="modal-title"><i style="font-size:18" class="fa">&#xf093;</i><b> Posting Tabungan Setor</b></h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
...
$(document).ready(function(){
    ...
    function tglhariini(){
        ...
        // $('#tglawalx1').val(tglsekarang);
        // $('#tglakhirx1').val(tglsekarang);
    }
    ...
    data1Datatable = tampil_data1();    
     function tampil_data1(){
        ...
        return $('#data1').DataTable({            
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('tabungan01.laporan.rekeningkoran_show')}}`,
            columns: [
    ...
    function tampil_data_carinasabah(){
        ...
        return $('#carinasabah').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('tabungan01.transaksi.tsetor_shownasabah')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    //         processing: true,
    //         serverSide: true,
    //         ajax   : `{{route('tabungan01.laporan.rekeningkoran_shownasabah')}}`,
    //         columns: [
    //             // { data: 'no', name:'id', render: function (data, type, row, meta) {
    //             //     return meta.row + meta.settings._iDisplayStart + 1;
    //             // }},
    ...
    function cariid(cari){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
            ...
            success : function(data){ 
                ...
                var y;                
                 for(i=0; i<resultData.length; i++){
                        ...
                        $('#produktabunganx1').val(resultData[i].produktabungan.produktabungan);
    ...
    function ambilcari(t){
        ...
        $('#namax1').val(nama1);
        $('#idnasabahx1').val(id1);
        $('#idproduktabunganx1').val(idproduktabungan1);
        $('#produktabunganx1').val(produktabungan1);
    ...
    function kirimsyarat(){
        ...
        var produktabunganx1=$('#produktabunganx1').val();
        ...
        let formData = new FormData();
            ...
            formData.append('produktabunganx1', produktabunganx1);
            ...
            formData.append('id6x', id6x);
            formData.append('noprintx6', noprintx6);
    
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('tabungan01/laporan/rekeningkoranedit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('tabungan01.laporan.rekeningkoran_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('tabungan01/laporan/rekeningkorandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_data();
    ...
    $('#show_data1').on('click','.item_printdetail',function(){
    ...
    $("#btn_print6").on('click',function(){
        ...
        window.open('{{ route('tabungan01.laporan.rekeningkoran_printdetail') }}');
    });
