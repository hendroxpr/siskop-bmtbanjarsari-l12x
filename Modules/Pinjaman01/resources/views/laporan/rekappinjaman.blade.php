                ...
                <table id="data1" class="table table-bordered table-striped table-hover" style="width: 100%">
                    <thead>
                        <tr>
							...
							<th style="width:50px">Tgl.Pinjam</th>
							...
							<th style="width:50px">Nilai Pinjaman</th>
							<th style="width:50px">Sudah Bayar</th>
							<th style="width:50px">Saldo</th>							
							<th style="width:50px">Total Ujroh</th>							
							<th style="width:50px">Total Admin</th>							
   ...
   $(document).ready(function(){
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            var totk4 = api
                ...
                $( api.column(10).footer() ).html(formatAngka(totk3,''));
                $( api.column(11).footer() ).html(formatAngka(totk4,''));
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pinjaman01.laporan.rekappinjaman_show')}}`,
            columns: [
                ...
                { data: 'ujroh', name: 'ujroh', class: 'text-right' },
                { data: 'admin', name: 'admin', class: 'text-right' },
                { data: 'lb', name: 'lb' },
    ...
    function kirimsyarat(){        
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pinjaman01.laporan.rekappinjaman_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
