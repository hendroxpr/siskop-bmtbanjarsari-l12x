            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 input-group">
                        <input name="nomorbuktix1" id="nomorbuktix1" class="form-control w3-input w3-border rounded-0" type="search" placeholder="PJM.001.20230131.0001" disabled value="{{ session('nomorbuktix1') }}">                        
                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">  
                                    <input name="debet1" id="debet1" class="w3-input w3-border text-right" style="background-color:gold" type="search" placeholder="Debet" value="0" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">                                
                                    <input name="tipe1" id="tipe1" maxlength="40" class="w3-input w3-border text-right" type="number" value="1" placeholder="tipe pinjaman" autocomplete="off">
                                </div>								  
                                <div class="col-md-4">                                
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">                                
                                    <input name="xangsuran1" id="xangsuran1" maxlength="40" class="w3-input w3-border text-right" type="number" value="1" placeholder="x angsuran" autocomplete="off">
                                </div>
                                <div class="col-md-4">                                
                                    <h6 class="mt-2">kali</h6>
                                </div>								  
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 input-group">
                                    <input name="nilaiangsuran1" id="nilaiangsuran1" class="form-control w3-input w3-border rounded-0 text-right" type="search" placeholder="nilai angsuran" value="0" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">                        
                                    <div class="input-group-append">
                                        <button id="btn_nilaiangsuran1" name="btn_nilaiangsuran1" type="button" style="border-radius:0px; border:none;" title="Generate Nilai Angsuran" disabled><i style="font-size:24" class="fa">&#xf013;</i></button>
                                    </div>                                    
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 input-group">                                
                                    <input name="ujroh1" id="ujroh1" class="form-control w3-input w3-input w3-border rounded-0 text-right" type="search" placeholder="ujroh" value="0" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                                    <button id="btn_ujroh1" name="btn_ujroh1" type="button" style="border-radius:0px; border:none;" title="Generate Ujroh" disabled><i style="font-size:24" class="fa">&#xf013;</i></button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="jatuhtempo1" id="jatuhtempo1" maxlength="40" class="w3-input w3-border" type="search" placeholder="jatuh tempo" autocomplete="off">
                                </div>								  
                            </div>
                            <div class="row">
                                <div class="col-md-4" align="right">										
...
$(document).ready(function(){
    ...
    data1Datatable = tampil_data1();    
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pinjaman01.transaksi.jurnalpinjaman_show')}}`,
            columns: [
     ...
     function tampil_data_carianggota(){
        ...
        return $('#carianggota').DataTable({
            ...
            processing: true,  
            serverSide: true,
            ajax   : `{{route('pinjaman01.transaksi.jurnalpinjaman_showanggota')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    function cariid(cari){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_cariid')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
            data : {cari1:cari1},
    ...
    function ambilcari(t){
        ...
        let x = jatuhtempo($('#tgltransaksix1').val(),30)
         $('#jatuhtempo1').val(x);       
    }

    //membuat kode Pinjaman
    function buatkodepinjaman(){
        ...
        let jpx = jp.substr(0,2);
        if(jp==''){
            jpx='00';
        }
        let ang = $('#idanggotax1').val();
        if(ang==''){
            ang = '0';
        }
        
        let angx = parseFloat(ang);
        let no;
        if(angx<10){
            no = '000'+angx;
        }else if(angx<100){
        ...
        let kode = b+'.'+jpx+'.'+no;
        $('#kodepinjamanx1').val(kode);

        const jpArray = jp.split(" ");
        let jpq =  jpArray[2];
        $('#keterangan1').val('Pengajuan Pinjaman ' + jpq);
    ...
    function tampil_listsandi1(){				
        $.ajax({
            type: 'get',
            url   : '{{route('pinjaman01.transaksi.jurnalpinjaman_listsandi')}}',
    ...
    function tampil_listcoa1(){				
        $.ajax({
            type: 'get',
            url   : '{{route('pinjaman01.transaksi.jurnalpinjaman_listcoa')}}',
    ...
    $('#idjenispinjamanx1').on('click',function(){
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                listcoa1Datatable.ajax.url('{{route('pinjaman01.transaksi.jurnalpinjaman_listcoa')}}').load();                
                listcoa1Datatable.draw(null, false);
                carianggotaDatatable.ajax.url('{{route('pinjaman01.transaksi.jurnalpinjaman_showanggota')}}').load();                
                carianggotaDatatable.draw(null, false);
    ...
    function data_jenispinjaman(idx){
        ...
        if(id1==''){
            ...
            $.ajax({
                type  : 'get',
                url   : `{{ url('pinjaman01/transaksi/jurnalpinjamanjenispinjaman')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function kirimsyarat(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_kirimsyarat')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_simpan(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function nomorbukti(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_nomorbukti')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function nomorposting(){        
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_nomorposting')}}',
            async : false,
            dataType : 'json',
            // data : FormData,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
                type  : 'get',
                url   : `{{ url('pinjaman01/transaksi/jurnalpinjamanedit')}}/${id1}`,
                async : false,
                dataType : 'json',	
    ...
    function data_posting(){
        ...
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pinjaman01.transaksi.jurnalpinjaman_posting')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('pinjaman01/transaksi/jurnalpinjamandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_data();
