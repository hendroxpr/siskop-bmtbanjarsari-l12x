...
class  JurnalpinjamanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan, menambah, mengubah dan menghapus <b>Jurnal Pinjaman</b>.<br>
            <div class="row">
        ...
        ';
        $page = 'pinjaman01::transaksi.jurnalpinjaman';
        $link = '/pinjaman01/transaksi/jurnalpinjaman';
        $subtitle = 'Transaksi';
        $caption = 'Jurnal Pinjaman';
        $jmlhal = 2;
    ...
    public function posting(Request $request)
    {
        ...
        */
        ...
        $tmp = Jurnalpinjaman::where('tgltransaksi','=',$tgltransaksi1)
    ...
    public function show()
    {
        ...
        ->addColumn('action', function ($row) {
            ...
            if(is_null($tglposting)){
                return '<a href="#" title="Edit Data" class="btn btn-success btn-xs item_edit" data="' . $row->id . '" data2="'. $row->coa->kode .'-' . $row->coa->coa.'" data3="'. $row->tgltransaksi.'" data4="'. $row->updated_at.'" data5="'. $row->nomorbukti.'" data6="'. $row->debet.'" data7="'. $row->tglposting.'" data8="'. $row->kredit.'"><i style="font-size:18px" class="fa">&#xf044;</i></a> ' .
    ...
    public function showanggota()
    {
        ...
        $idanggota = Jurnalpinjaman::select('idanggota')
            ->where('idjenispinjaman','=',$idjenispinjaman1)
            ->where('lb','=','Belum')
            ->get();
    ...
    public function nomorbukti(Request $request)
    {
        ...
        //nomor kwitansi contoh : PJM.001.20230527.0009
        $nbx = 'PJM' . '.' . $idx . '.' . $tgl1 . '.' . $no;  
        $nomorbukti = "'$nbx'";
