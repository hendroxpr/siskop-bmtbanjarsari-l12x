...
class  DetailpinjamanController extends Controller
{
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan <b>Detail Pinjaman</b>';
        $page = 'pinjaman01::laporan.detailpinjaman';
        $link = '/pinjaman01/laporan/detailpinjaman';
        $subtitle = 'Laporan';
    ...
    public function show()
    {
        ...
        $kode = session('kodepinjamanx1');
        // $idjenispinjaman1 = Jurnalpinjaman::select('idjenispinjaman')
        //     ->where('kode','=',$kode)
        //     ->get();
        ...
        $data = $datax
            ...
            ->addColumn('saldo', function ($row) {
                $debet = Jurnalpinjaman::select('debet')
                    ->where('kode','=',$row->kode)
                ...
                $kredit = Jurnalpinjaman::select('kredit')
                    ...
                    ->where('created_at','<=',$row->created_at)
                    ->sum('kredit');
                return number_format($debet-$kredit,'0');
            })
    ...
    public function cariid(Request $request)
    {
        ...
        $data = Jurnalpinjaman::limit(1)->select('*')
                ->with(['anggota'])
                ->where('kode','=',$cari)
                ->get();
